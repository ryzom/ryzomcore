...
{block name=menu}
	...
	<li style="margin-left: -2px;"><a class="ajax-link" href="index.php?page=plugins"><span class="icon-th-list"></span><span class="hidden-tablet"> Plugins</span></a></li>  
        <li style="margin-left: -2px;"><a class="ajax-link" href="index.php?page=syncing"><span class="icon-th-list"></span><span class="hidden-tablet"> Syncing</span></a></li>
