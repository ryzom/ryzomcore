...
// SoniX: par ex, sur un AIS :  "getView (0x0000000001:15:83:83).NamedEntityState" r�cup�re le state de l'entit� specifier
// SoniX: "getView *.NamedEntityName" r�cup�re toutes les entit� nomm� de l'IA sur laquelle tu balance la commande
// SoniX: et pour setter une valuer :
// SoniX: "getView (0x0000000001:15:83:83).NamedEntityState=1" met le truc � 1
// SoniX: En gros, tu r�cup�res les info dans la table variables, et tu vire les 3 premier morceaux (par ex, *.*.AIS.*.NamedEntityName deviens *.NamedEntityName).
...
// SoniX: j'ai tester sur linuxshard8, d'jon mark a r�activ� un morceau d'�poside 2 dessus avec 1 variable
// YoGiN: d'accord
