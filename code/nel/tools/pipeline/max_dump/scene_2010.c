...
Scene
(StorageContainer) [1] {
0x2012: (StorageContainer) [452] {
	0x0000: (StorageContainer) [6] {
		0x000b: (StorageRaw) {
			Size: 24
			String: <).Z..B0`......!........
	...
	0x0005: (StorageContainer) [4] {
		...
		0x5300: (StorageRaw) {
			...
			String: ....
			Hex: 02 00 00 00 }
		0x5020: (StorageContainer) [1] {
			0x0322: (StorageRaw) {
				Size: 4
				String: ....
				Hex: 00 00 00 00 } } }
	0x0000: (StorageContainer) [8] {
		0x0009: (StorageRaw) {
			Size: 16
			String: .......!........
	...
	0x0007: (StorageContainer) [4] {
		...
		0x0200: (StorageRaw) {
			...
			String: ....
			Hex: 02 00 00 00 }
		0x39bf: (StorageContainer) [1] {
			0x0100: (StorageRaw) {
				Size: 0
				String:
				Hex: } } }
	0x0008: (StorageContainer) [6] {
		0x2034: (StorageRaw) {
			Size: 36
			String: ....................................
		...
		0x204b: (StorageRaw) {
			...
			String: .
			Hex: 2e }
		0x21b0: (StorageContainer) [1] {
			0x1020: (StorageRaw) {
				Size: 4
				String: ....
				Hex: 04 00 00 00 } }
		0x4000: (StorageContainer) [4] {
			0x4001: (StorageRaw) {
				Size: 24
	...
	0x0006: (StorageContainer) [15] {
		...
		0x0002: (StorageContainer) [3] {
			...
			0x0100: (StorageRaw) {
				...
				String: ....
				Hex: 00 00 00 00 } } }
	0x000a: (StorageContainer) [9] {
		0x2150: (StorageContainer) [2] {
			0x0100: (StorageRaw) {
				Size: 4
				String: ....
				Hex: 01 00 00 00 }
	...
	0x0017: (StorageContainer) [1] {
		0x2535: (StorageRaw) {
			Size: 4
			String: ....
			Hex: 00 00 00 00 } }
	0x0018: (StorageContainer) [12] {
		0x2150: (StorageContainer) [3] {
			0x0100: (StorageRaw) {
				Size: 4
				String: ....
				Hex: 02 00 00 00 }
	...
	0x0019: (StorageContainer) [9] {
		...
		0x1080: (StorageRaw) {
			...
			String: ....
			Hex: 00 00 00 00 } }
	0x001a: (StorageContainer) [25] {
		0x2150: (StorageContainer) [84] {
			0x0100: (StorageRaw) {
				Size: 4
				String: S...
				Hex: 53 00 00 00 }
		...
		0x0ac3: (StorageRaw) {
			...
			String: ....
			Hex: 01 00 00 00 }
		0x0ad2: (StorageContainer) [1] {
			0x0006: (StorageRaw) {
				Size: 21
				String: .........?..........?
				Hex: 00 00 01 00 00 01 00 00 80 3f 00 01 01 01 01 00 00 00 00 80 3f } }
		0x0b22: (StorageContainer) [10] {
			0x0100: (StorageRaw) {
				Size: 4
				String: ....
				Hex: 00 00 00 00 }
		...
		0x0af0: (StorageContainer) [8] {
			...
			0x0008: (StorageRaw) {
				...
				String: ....
				Hex: 00 00 00 00 } }
		0x0b0e: (StorageContainer) [1] {
			0x0001: (StorageContainer) [24] {
				0x0002: (StorageRaw) {
					Size: 4
					String: ....
					Hex: 00 00 00 00 }
		...
		0x0b4a: (StorageRaw) {
			...
			String: .
			Hex: 00 }
		0x0b54: (StorageContainer) [1] {
			0x0001: (StorageContainer) [1] {
				0x0002: (StorageRaw) {
					Size: 4
					String: ....
					Hex: 00 00 00 00 } } }
		0x0b5e: (StorageContainer) [1] {
			0x0001: (StorageContainer) [1] {
				0x0005: (StorageRaw) {
					Size: 4
					String: ....
					Hex: 02 00 00 00 } } } }
	0x001b: (StorageContainer) [1] {
		0x39bf: (StorageContainer) [1] {
			0x0100: (StorageRaw) {
				Size: 0
				String:
				Hex: } } }
	0x001c: (StorageContainer) [20] {
		0x2034: (StorageRaw) {
			Size: 4
			String: ....
			Hex: 86 01 00 00 }
	...
	0x001f: (StorageContainer) [7] {
		...
		0x0120: (StorageRaw) {
			...
			String: ....
			Hex: 00 00 00 00 }
		0x0110: (StorageContainer) [5] {
			0x2000: (StorageContainer) [41] {
				0x0100: (StorageRaw) {
					Size: 4
					String: ....
					Hex: 01 05 00 00 }
	...
	0x0021: (StorageContainer) [23] {
		...
		0x0130: (StorageRaw) {
			...
			String: ....
			Hex: 01 00 00 00 } }
	0x0029: (StorageContainer) [1] {
		0x0001: (StorageContainer) [1] {
			0x0010: (StorageRaw) {
				Size: 4
				String: ....
				Hex: 01 00 00 00 } } }
	0x0021: (StorageContainer) [6] {
		0x2034: (StorageRaw) {
			Size: 4
			String: ....
			Hex: a6 01 00 00 }
	...
	0x0036: (StorageContainer) [5] {
		...
		0x1700: (StorageRaw) {
			...
			String: 0
			Hex: 30 } }
	0x0037: (StorageContainer) [1] {
		0x0100: (StorageRaw) {
			Size: 4
			String: ....
			Hex: 00 00 00 00 } }
	0x0038: (StorageContainer) [8] {
		0x2034: (StorageRaw) {
			Size: 48
			String: w...x.......|...................................
