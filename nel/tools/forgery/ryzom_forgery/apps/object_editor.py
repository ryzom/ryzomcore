...
from panda3d.core import (
	...
	Quat, RenderAttrib, Shader, Texture as PandaTexture, TextureStage, TransformState,
)
...
class ObjectEditorApp(
		MeshImportMixin, PanoplyUIMixin, ReferenceShapesMixin, SettingsDialogsMixin, ShapeIOMixin,
