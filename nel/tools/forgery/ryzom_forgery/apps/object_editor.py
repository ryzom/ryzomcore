...
from ryzom_forgery.shape_geometry import (
	...
	resolve_texture_ref, rgba_to_color, shape_bbox, shape_geom, solid_color_texture, texture_to_pnm_image,
	uv_matrix_to_panda_mat4,
)
...
from ryzom_forgery.apps.object_editor_mixins.ui_helpers import (
	_colored_button, _CONFIRM_NO_COLOR, _CONFIRM_YES_COLOR, _icon_button, _MULTI_BITMAP_SLOT_LABELS,
	_OBJECT_TRANSPARENCY_ALPHA, _VIEWPORT_TOGGLE_MARGIN_PX,
)
...
class ObjectEditorApp(
		MeshImportMixin, ReferenceShapesMixin, SettingsDialogsMixin, ShapeIOMixin, ViewportTransformMixin, ForgeryApp):
	def __init__(self):
