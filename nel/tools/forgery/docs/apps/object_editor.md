...
- **Section "Ryzom Paths" (2026-09-08, `ryzom_forgery/ryzom_paths_section.py`)** : Settings > Ryzom Paths, regroupe sous un header unique 3 réglages génériques de toute la suite Forgery (pas propres à Patina) -- réutilisable tel quel par n'importe quelle app (voir `docs/apps/landscape_editor.md`'s "Onglets" pour Atyscape) :
