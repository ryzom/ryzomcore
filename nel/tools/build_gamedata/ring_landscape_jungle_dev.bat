...
0_setup.py --noconf -ipj continents/r2_jungle
title Ryzom Core: 1_export.py (RING LANDSCAPE)
1_export.py -ipj continents/r2_jungle
title Ryzom Core: 2_build.py (RING LANDSCAPE)
2_build.py -ipj continents/r2_jungle
title Ryzom Core: 3_install.py (RING LANDSCAPE)
3_install.py -ipj continents/r2_jungle
