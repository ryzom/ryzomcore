...
public:
	static int getRotation(QWidget *parent, bool *ok = nullptr, Qt::WindowFlags f = Qt::WindowFlags());
...
private:
	CTile_rotation_dlg(QWidget *parent = nullptr, Qt::WindowFlags f = Qt::WindowFlags());
