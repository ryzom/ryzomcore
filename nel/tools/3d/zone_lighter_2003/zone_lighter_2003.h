...
#ifndef NL_ZONE_LIGHTER_2003_H
#define NL_ZONE_LIGHTER_2003_H
...
#define MAX_CPU_PROCESS 10
	...
	float attenuation (const CVector &pos, const CZoneLighter2003::CLightDesc &description);
