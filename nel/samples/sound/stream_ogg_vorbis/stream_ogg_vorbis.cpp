...
static UStreamSource *s_StreamSource = nullptr;
static IAudioDecoder *s_AudioDecoder = nullptr;
...
static void releaseSample()
{
	...
	delete s_AudioDecoder; s_AudioDecoder = nullptr;
	delete s_StreamSource; s_StreamSource = nullptr;
