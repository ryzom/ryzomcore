...
public:
	...
	// raytracing test
	virtual bool raytrace(const NLMISC::CVector &start, const NLMISC::CVector &end, NLMISC::CVector &inter, std::vector<NLMISC::CTriangle> *testedTriangles = nullptr, NLMISC::CVector *normal = nullptr) const;
	//
