...
mkdir nel_plugins_3dsmax_2017_x64
cd nel_plugins_3dsmax_2017_x64
copy "%RC_ROOT%\build\3dsmax\2017_x64\bin\Release\object_viewer_dll_r.dll" "object_viewer_dll_r.dll"
copy "%RC_ROOT%\build\3dsmax\2017_x64\bin\Release\nel_3dsmax_shared_r.dll" "nel_3dsmax_shared_r.dll"
...
copy "%RC_ROOT%\build\3dsmax\2017_x64\bin\Release\tile_utility_r.dlu" "neltileutility_r.dlu"
copy "%RC_ROOT%\build\3dsmax\2017_x64\bin\Release\nel_vertex_tree_paint_r.dlm" "nel_vertex_tree_paint_r.dlm"
copy "%RC_ROOT%\build\3dsmax\2017_x64\bin\Release\ligoscape_utility_r.dlx" "nelligoscapeutility_r.dlx"
