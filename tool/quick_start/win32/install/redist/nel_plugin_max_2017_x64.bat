...
rmdir /s /q nel_plugin_max_2017_x64
if %errorlevel% neq 0 pause
mkdir nel_plugin_max_2017_x64
cd nel_plugin_max_2017_x64
copy "%RC_ROOT%\build_win32\plugin_max\2017_x64\bin\object_viewer_dll_r.dll" "object_viewer_dll_r.dll"
copy "%RC_ROOT%\build_win32\plugin_max\2017_x64\bin\nel_3dsmax_shared_r.dll" "nel_3dsmax_shared_r.dll"
rem copy "%RC_ROOT%\build_win32\plugin_max\2017_x64\bin\nel_drv_opengl_win_r.dll" "nel_drv_opengl_win_r.dll"
...
copy "%RC_ROOT%\build_win32\plugin_max\2017_x64\bin\tile_utility_r.dlu" "neltileutility_r.dlu"
copy "%RC_ROOT%\build_win32\plugin_max\2017_x64\bin\nel_vertex_tree_paint_r.dlm" "nel_vertex_tree_paint_r.dlm"
copy "%RC_ROOT%\build_win32\plugin_max\2017_x64\bin\ligoscape_utility_r.dlx" "nelligoscapeutility_r.dlx"
copy "%RC_ROOT%\build_win32\plugin_max\2017_x64\bin\mapext198m3.dlm" "mapext198m3.dlm"
