...
copy %RC_ROOT%\build_win32\server_dev\bin\Release\ryzom_patchman_service.exe ryzom_patchman_service.exe

copy %RC_ROOT%\build_win32\tools\bin\Release\sheets_packer.exe sheets_packer.exe
copy %RC_ROOT%\build_win32\tools\bin\Release\sheets_packer_shard.exe sheets_packer_shard.exe

copy %RC_ROOT%\build_win32\tools\bin\Release\build_world_packed_col.exe build_world_packed_col.exe
copy %RC_ROOT%\build_win32\tools\bin\Release\ai_build_wmap.exe ai_build_wmap.exe
copy %RC_ROOT%\build_win32\tools\bin\Release\r2_islands_textures.exe r2_islands_textures.exe
copy %RC_ROOT%\build_win32\tools\bin\Release\land_export.exe land_export.exe
copy %RC_ROOT%\build_win32\tools\bin\Release\prim_export.exe prim_export.exe

copy %RC_ROOT%\build_win32\tools\bin\Release\ryzom_mission_compiler.exe ryzom_mission_compiler.exe
copy %RC_ROOT%\build_win32\tools\bin\Release\ryzom_mission_compiler_fe.exe ryzom_mission_compiler_fe.exe

copy %RC_ROOT%\build_win32\tools\bin\Release\patch_gen_service.exe patch_gen_service.exe
copy %RC_ROOT%\build_win32\tools\bin\Release\stats_scan.exe stats_scan.exe
copy %RC_ROOT%\build_win32\tools\bin\Release\patch_gen.exe patch_gen.exe
copy %RC_ROOT%\build_win32\tools\bin\Release\pdr_util.exe pdr_util.exe
copy %RC_ROOT%\build_win32\tools\bin\Release\alias_synchronizer.exe alias_synchronizer.exe
copy %RC_ROOT%\build_win32\tools\bin\Release\translation_tools.exe translation_tools.exe
copy %RC_ROOT%\build_win32\tools\bin\Release\uni_conv.exe uni_conv.exe
copy %RC_ROOT%\build_win32\tools\bin\Release\make_alias_file.exe make_alias_file.exe
copy %RC_ROOT%\build_win32\tools\bin\Release\skill_extractor.exe skill_extractor.exe
copy %RC_ROOT%\build_win32\tools\bin\Release\assoc_mem.exe assoc_mem.exe
copy %RC_ROOT%\build_win32\tools\bin\Release\pd_parser.exe pd_parser.exe
copy %RC_ROOT%\build_win32\tools\bin\Release\7zDec.exe 7zDec.exe
copy %RC_ROOT%\build_win32\tools\bin\Release\named2csv.exe named2csv.exe
copy %RC_ROOT%\build_win32\tools\bin\Release\make_anim_by_race.exe make_anim_by_race.exe
copy %RC_ROOT%\build_win32\tools\bin\Release\make_anim_melee_impact.exe make_anim_melee_impact.exe
copy %RC_ROOT%\build_win32\tools\bin\Release\mp_generator.exe mp_generator.exe
copy %RC_ROOT%\build_win32\tools\bin\Release\icon_search.exe icon_search.exe
copy %RC_ROOT%\build_win32\tools\bin\Release\csv_transform.exe csv_transform.exe

copy %RC_ROOT%\build_win32\tools\bin\Release\georges.exe georges.exe
copy %RC_ROOT%\build_win32\tools\bin\Release\georges_dll_r.dll georges_dll_r.dll
copy %RC_ROOT%\build_win32\tools\bin\Release\georges_plugin_sound_r.dll georges_plugin_sound_r.dll

copy %RC_ROOT%\build_win32\tools\bin\Release\world_editor.exe world_editor.exe
copy %RC_ROOT%\build_win32\tools\bin\Release\world_editor_sound_plugin_r.dll world_editor_sound_plugin_r.dll
copy %RC_ROOT%\build_win32\tools\bin\Release\world_editor_fauna_graph_plugin_r.dll world_editor_fauna_graph_plugin_r.dll
copy %RC_ROOT%\build_win32\tools\bin\Release\world_editor_graph_plugin_r.dll world_editor_graph_plugin_r.dll
copy %RC_ROOT%\build_win32\tools\bin\Release\world_editor_primitive_plugin_r.dll world_editor_primitive_plugin_r.dll
copy %RC_ROOT%\build_win32\tools\bin\Release\world_editor_shard_monitor_plugin_r.dll world_editor_shard_monitor_plugin_r.dll
