...
rmdir /s /q nel_plugin_max_2020_x64
if %errorlevel% neq 0 pause
mkdir nel_plugin_max_2020_x64
cd nel_plugin_max_2020_x64
copy "%RC_ROOT%\build_win32\plugin_max\2020_x64\bin\object_viewer_dll_r.dll" "object_viewer_dll_r.dll"
copy "%RC_ROOT%\build_win32\plugin_max\2020_x64\bin\nel_3dsmax_shared_r.dll" "nel_3dsmax_shared_r.dll"
rem copy "%RC_ROOT%\build_win32\plugin_max\2020_x64\bin\nel_drv_opengl_win_r.dll" "nel_drv_opengl_win_r.dll"
rem copy "%RC_ROOT%\build_win32\plugin_max\2020_x64\bin\nel_drv_xaudio2_win_r.dll" "nel_drv_xaudio2_win_r.dll"
"C:\Program Files\Microsoft SDKs\Windows\v6.0A\Bin\signtool.exe" sign /sha1 f0ef3c22d0373d2d6e3735207194d097c8f69877 /t http://timestamp.comodoca.com/authenticode "*.dll"
rem copy "C:\2021q4_external_v143_x64\ogg\bin\ogg.dll" "ogg.dll"
rem copy "C:\2021q4_external_v143_x64\libpng\bin\libpng16.dll" "libpng16.dll"
rem copy "C:\2021q4_external_v143_x64\vorbis\bin\vorbis.dll" "vorbis.dll"
rem copy "C:\2021q4_external_v143_x64\vorbis\bin\vorbisfile.dll" "vorbisfile.dll"
rem copy "C:\2021q4_external_v143_x64\libjpeg\bin\jpeg62.dll" "jpeg62.dll"
rem copy "C:\2021q4_external_v143_x64\libxml2\bin\libxml2.dll" "libxml2.dll"
rem copy "C:\2021q4_external_v143_x64\libiconv\bin\libiconv.dll" "libiconv.dll"
rem copy "C:\2021q4_external_v143_x64\libiconv\bin\libcharset.dll" "libcharset.dll"
rem copy "C:\2021q4_external_v143_x64\zlib\bin\zlib.dll" "zlib.dll"
rem copy "C:\2021q4_external_v143_x64\freetype\bin\freetype.dll" "freetype.dll"
mkdir plugins
cd plugins
...
copy "%RC_ROOT%\build_win32\plugin_max\2020_x64\bin\tile_utility_r.dlu" "neltileutility_r.dlu"
copy "%RC_ROOT%\build_win32\plugin_max\2020_x64\bin\nel_vertex_tree_paint_r.dlm" "nel_vertex_tree_paint_r.dlm"
copy "%RC_ROOT%\build_win32\plugin_max\2020_x64\bin\ligoscape_utility_r.dlx" "nelligoscapeutility_r.dlx"
copy "%RC_ROOT%\build_win32\plugin_max\2020_x64\bin\mapext198m3.dlm" "mapext198m3.dlm"
