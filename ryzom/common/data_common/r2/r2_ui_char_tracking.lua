...
function CharTracking:newTextLabel(value)		
	...
	scratchUCStr = value
	group:find("t").hardtext_single_line_format = scratchUCStr
	return group
end
...
function CharTracking:newNumberLabel(value)	
	...
	group:find("t").hardtext_single_line_format = tostring(value)
	return group
end
...
function CharTracking:onLineRightClick()
	...
	menu:find("tell").hardtext = i18n.get("uiRAP_MenuCharTell") .. "'" .. self:getCharFromId(self.SelectedCharId).Char .."'"
	menu:find("teleport").hardtext = i18n.get("uiRAP_MenuTeleportTo") .. "'" .. self:getCharFromId(self.SelectedCharId).Char.."'"
	menu:find("kick").hardtext = i18n.get("uiRAP_MenuKick") .. "'" .. self:getCharFromId(self.SelectedCharId).Char.."'"
	menu:find("unkick").hardtext = i18n.get("uiRAP_MenuUnkick") .. "'" .. self:getCharFromId(self.SelectedCharId).Char.."'"
...
function CharTracking:onTell()
	...
	char = ""	
	char = self:getCharFromId(self.SelectedCharId).Char
