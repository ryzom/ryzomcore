...
function r2:updateActionEditor()
	...
	whichEventNameText.hardtext = text
	
	if actionInst ~= nil then

		local index = r2:searchElementIndex(actionInst)
		if index~= nil then
			actionName.hardtext = tostring(i18n.get("uiR2EdAction")).." "..index.." : "
		else
			actionName.hardtext = tostring(i18n.get("uiR2EdAction")).." : "
		end
		...
		for i=0, actionInst.Conditions.Size-1 do
			...
			whatConditionText.hardtext = text
		...
		actionName.hardtext = name

		whichEventText.hardtext = "" 
	end
end
...
function r2:buildReactionTitle(reactionUI, erase)
	...
	elseif erase==true then
		...
		title.hardtext = tostring(i18n.get("uiR2EdReaction")).." "..indexReactionUI.." : "
	end
end
...
function r2:updateReactionEditor()
	...
	if not reactionEltUI.Env.WhatTriggers then
		...
		whatActionText.hardtext = ""
		whatTriggersText.hardtext = ""
		whichEventText.hardtext = ""
		...
		whatTriggersText.hardtext = entityName
