...
function baseClass.setDeleteActionName(this)
	r2.requestNewAction((i18n.get("uiR2EDDeleteAction") .. this:getDisplayName()))
end
...
function baseClass.onSetupMenu(this)
	...
	-- 	menu["selectParent" .. tostring(i)].hardtext = i18n.get("uimR2EDSelectParent") + (parent.InstanceId .. "  (" .. parent.Class .. ")")
...
function baseClass.setRefIdValue(this, refIdName, targetId)	
	...
	if targetId == "" then
	r2.requestNewAction((i18n.get("uiR2EDRemovingTargetAction") .. name .. i18n.get("uiR2EDAddingReferenceSeparator") .. refIdname))
	else
		local targetName = r2:getInstanceFromId(targetId):getDisplayName()
		r2.requestNewAction((i18n.get("uiR2EDAddingReferenceAction") .. name .. i18n.get("uiR2EDAddingReferenceSeparator") .. refIdUCName .. i18n.get("uiR2EDAddingReferenceToAction") .. targetName))
	end
