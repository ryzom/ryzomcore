...
if RYZOM_ARK_SHOP_VERSION ~= 324 then broadcastBadLuaVersions(RYZOM_ARK_SHOP_VERSION, 324, "ark_shop") end
...
if RYZOM_RAW_CREATURE_MATS_VERSION ~= 324 then broadcastBadLuaVersions(RYZOM_RAW_CREATURE_MATS_VERSION, 324, "raw_creature_mats") end
...
if RYZOM_SEARCH_COMMAND_VERSION ~= 328 then broadcastBadLuaVersions(RYZOM_SEARCH_COMMAND_VERSION, 328, "search_command") end
...
if RYZOM_WORLD_VERSION ~= 324 then broadcastBadLuaVersions(RYZOM_WORLD_VERSION, 324, "world") end
