	...
	for i = 0,(nbMember-1) do
		...
		if (uiMember ~= nil) then
			...
			if (memberGrade == 'Leader') then
				uiMember.grade.hardtext = i18n.get('uiGuildLeader');
			elseif (memberGrade == 'HighOfficer') then
				uiMember.grade.hardtext = i18n.get('uiGuildHighOfficer');
			elseif (memberGrade == 'Officer') then
				uiMember.grade.hardtext = i18n.get('uiGuildOfficer');
			else
				uiMember.grade.hardtext = i18n.get('uiGuildMember');
			end
