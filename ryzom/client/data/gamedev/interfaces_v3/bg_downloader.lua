...
function bgdownloader:setPatchProgress(progress)	
	...
	self:setProgressText((i18n.get("uiBGD_Progress") .. progressPercentText), color, progress, progressSymbol[progressPostfix + 1])
end
