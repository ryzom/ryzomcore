...
static CISPFeedAnimal *		ISPFeedAnimal5		= new CISPFeedAnimal(ITEM_SERVICE_TYPE::StableFeedAnimal5, 5);
static CISPFeedAnimal *		ISPFeedAnimal6		= new CISPFeedAnimal(ITEM_SERVICE_TYPE::StableFeedAnimal6, 6);
static CISPFeedAnimal *		ISPFeedAnimal7		= new CISPFeedAnimal(ITEM_SERVICE_TYPE::StableFeedAnimal7, 7);
