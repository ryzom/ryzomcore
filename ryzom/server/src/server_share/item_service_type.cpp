...
namespace ITEM_SERVICE_TYPE
{
	...
	NL_BEGIN_STRING_CONVERSION_TABLE (TItemServiceType)
		...
		NL_STRING_CONVERSION_TABLE_ENTRY(StableFeedAnimal5)
		NL_STRING_CONVERSION_TABLE_ENTRY(StableFeedAnimal6)
		NL_STRING_CONVERSION_TABLE_ENTRY(StableFeedAnimal7)
