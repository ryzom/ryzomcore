...
CAdminCommandLog AdminCommandLog;
bool VerboseAdminCommands = true;

//-----------------------------------------------
// CAdminCommandLog init
//-----------------------------------------------
void CAdminCommandLog::init(const std::string & logFile)
{
	_LogFile = logFile;
	if ( logFile.empty() )
...
//-----------------------------------------------
//-----------------------------------------------
void CAdminCommandLog::display(const char *format, ...)
{
	if (Log == NULL) return;
